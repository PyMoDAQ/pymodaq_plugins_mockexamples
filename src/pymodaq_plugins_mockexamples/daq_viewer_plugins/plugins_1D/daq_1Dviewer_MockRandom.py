...
class DAQ_1DViewer_MockRandom(DAQ_Viewer_base):
    ...
    def grab_data(self, Naverage=1, **kwargs):
        ...
        xaxis, data = self.controller.get_data_1D()
        data = DataFromPlugins(name='RandomData', data=[data],
                               axes=[Axis('random xaxis', data = xaxis)])
